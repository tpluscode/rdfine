...
export interface NegativePropertyAssertion<ID extends ResourceNode = ResourceNode> extends Rdfs.Resource<ID>, RdfResource<ID> {
  assertionProperty: Rdf.Property<SiblingNode<ID>> | undefined;
