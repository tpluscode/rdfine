...
export const factory = (env: RdfineEnvironment) => createFactory<InverseFunctionalProperty>([ObjectPropertyMixin, InverseFunctionalPropertyMixin], { types: [owl.InverseFunctionalProperty] }, env);
