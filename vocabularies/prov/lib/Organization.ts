...
declare global {
  interface ProvVocabulary {
    Organization: Factory<Prov.Organization>;
  }
}
...
OrganizationMixin.createFactory = (env: RdfineEnvironment) => createFactory<Organization>([AgentMixin, OrganizationMixin], { types: [prov.Organization] }, env)
