...
declare global {
  interface ProvVocabulary {
    KeyEntityPair: Factory<Prov.KeyEntityPair>;
  }
}
...
KeyEntityPairMixin.createFactory = (env: RdfineEnvironment) => createFactory<KeyEntityPair>([KeyEntityPairMixin], { types: [prov.KeyEntityPair] }, env)
