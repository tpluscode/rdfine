...
export const factory = (env: RdfineEnvironment) => createFactory<Generation>([InstantaneousEventMixin, ActivityInfluenceMixin, GenerationMixin], { types: [prov.Generation] }, env);
