...
OrderedCollectionMixin.createFactory = (env: RdfineEnvironment) => createFactory<OrderedCollection>([CollectionMixin, OrderedCollectionMixin], { types: [skos.OrderedCollection] }, env)
