...
export function IntransitiveActivityMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<IntransitiveActivity> & RdfResourceCore> & Base {
  @rdfine.namespace(as)
