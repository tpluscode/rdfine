...
export const factory = (env: RdfineEnvironment) => createFactory<ScriptFunction>([ScriptMixin, ShaclFunctionMixin, ScriptFunctionMixin], { types: [dash.ScriptFunction] }, env);
