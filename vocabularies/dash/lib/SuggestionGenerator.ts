...
export const factory = (env: RdfineEnvironment) => createFactory<SuggestionGenerator>([RdfsResourceMixin, SuggestionGeneratorMixin], { types: [dash.SuggestionGenerator] }, env);
