...
export const factory = (env: RdfineEnvironment) => createFactory<SuccessTestCaseResult>([TestCaseResultMixin, SuccessTestCaseResultMixin], { types: [dash.SuccessTestCaseResult] }, env);
