...
ConstructorMixin.createFactory = (env: RdfineEnvironment) => createFactory<Constructor>([ScriptMixin, ShaclParameterizableMixin, ConstructorMixin], { types: [dash.Constructor] }, env)
