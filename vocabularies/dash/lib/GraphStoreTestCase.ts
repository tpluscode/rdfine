...
export function GraphStoreTestCaseMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<GraphStoreTestCase> & RdfResourceCore> & Base {
