...
export interface SPARQLExecutable<ID extends ResourceNode = ResourceNode> extends Rdfs.Resource<ID>, RdfResource<ID> {
  prefixes: Owl.Ontology<SiblingNode<ID>> | undefined;
}
