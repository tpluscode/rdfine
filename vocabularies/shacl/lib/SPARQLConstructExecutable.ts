...
export const factory = (env: RdfineEnvironment) => createFactory<SPARQLConstructExecutable>([SPARQLExecutableMixin, SPARQLConstructExecutableMixin], { types: [sh.SPARQLConstructExecutable] }, env);
