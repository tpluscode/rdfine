...
declare global {
  interface SchemaVocabulary {
    UserLikes: Factory<Schema.UserLikes>;
  }
}
...
UserLikesMixin.createFactory = (env: RdfineEnvironment) => createFactory<UserLikes>([UserInteractionMixin, UserLikesMixin], { types: [schema.UserLikes] }, env)
