...
export interface Chapter<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
  pageEnd: number | string | undefined;
  pageStart: number | string | undefined;
  pagination: string | undefined;
}

export function ChapterMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
