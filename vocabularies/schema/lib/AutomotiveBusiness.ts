...
export function AutomotiveBusinessMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<AutomotiveBusiness> & RdfResourceCore> & Base {
