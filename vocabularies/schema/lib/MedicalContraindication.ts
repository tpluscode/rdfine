...
export function MedicalContraindicationMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<MedicalContraindication> & RdfResourceCore> & Base {
