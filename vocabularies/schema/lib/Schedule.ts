...
export interface Schedule<ID extends ResourceNode = ResourceNode> extends Schema.Intangible<ID>, RdfResource<ID> {
  ...
  repeatFrequency: Schema.Duration<SiblingNode<ID>> | undefined;
