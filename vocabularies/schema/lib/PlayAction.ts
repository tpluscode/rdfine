...
declare global {
  interface SchemaVocabulary {
    PlayAction: Factory<Schema.PlayAction>;
  }
}
...
PlayActionMixin.createFactory = (env: RdfineEnvironment) => createFactory<PlayAction>([ActionMixin, PlayActionMixin], { types: [schema.PlayAction] }, env)
