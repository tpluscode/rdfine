...
declare global {
  interface SchemaVocabulary {
    FindAction: Factory<Schema.FindAction>;
  }
}
...
FindActionMixin.createFactory = (env: RdfineEnvironment) => createFactory<FindAction>([ActionMixin, FindActionMixin], { types: [schema.FindAction] }, env)
