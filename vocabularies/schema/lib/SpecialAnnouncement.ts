...
export const factory = (env: RdfineEnvironment) => createFactory<SpecialAnnouncement>([CreativeWorkMixin, SpecialAnnouncementMixin], { types: [schema.SpecialAnnouncement] }, env);
