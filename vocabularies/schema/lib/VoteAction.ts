...
export interface VoteAction<ID extends ResourceNode = ResourceNode> extends Schema.ChooseAction<ID>, RdfResource<ID> {
  candidate: Schema.Person<SiblingNode<ID>> | undefined;
}
