...
export const factory = (env: RdfineEnvironment) => createFactory<MovingCompany>([HomeAndConstructionBusinessMixin, MovingCompanyMixin], { types: [schema.MovingCompany] }, env);
