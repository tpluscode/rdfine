...
export function MedicalRiskFactorMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<MedicalRiskFactor> & RdfResourceCore> & Base {
