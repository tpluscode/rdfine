...
export const factory = (env: RdfineEnvironment) => createFactory<PreventionIndication>([MedicalIndicationMixin, PreventionIndicationMixin], { types: [schema.PreventionIndication] }, env);
