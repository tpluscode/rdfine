...
export function PreventionIndicationMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<PreventionIndication> & RdfResourceCore> & Base {
