...
export interface LoseAction<ID extends ResourceNode = ResourceNode> extends Schema.AchieveAction<ID>, RdfResource<ID> {
  winner: Schema.Person<SiblingNode<ID>> | undefined;
}
