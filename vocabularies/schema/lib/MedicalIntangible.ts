...
export function MedicalIntangibleMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<MedicalIntangible> & RdfResourceCore> & Base {
