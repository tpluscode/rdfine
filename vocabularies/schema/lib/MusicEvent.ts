...
declare global {
  interface SchemaVocabulary {
    MusicEvent: Factory<Schema.MusicEvent>;
  }
}
...
MusicEventMixin.createFactory = (env: RdfineEnvironment) => createFactory<MusicEvent>([EventMixin, MusicEventMixin], { types: [schema.MusicEvent] }, env)
