...
export interface Audience<ID extends ResourceNode = ResourceNode> extends Schema.Intangible<ID>, RdfResource<ID> {
  audienceType: string | undefined;
  geographicArea: Schema.AdministrativeArea<SiblingNode<ID>> | undefined;
}
