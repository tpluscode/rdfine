...
declare global {
  interface SchemaVocabulary {
    BarOrPub: Factory<Schema.BarOrPub>;
  }
}
...
BarOrPubMixin.createFactory = (env: RdfineEnvironment) => createFactory<BarOrPub>([FoodEstablishmentMixin, BarOrPubMixin], { types: [schema.BarOrPub] }, env)
