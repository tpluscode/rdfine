...
VesselMixin.createFactory = (env: RdfineEnvironment) => createFactory<Vessel>([AnatomicalStructureMixin, VesselMixin], { types: [schema.Vessel] }, env)
