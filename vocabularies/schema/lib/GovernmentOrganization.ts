...
export const factory = (env: RdfineEnvironment) => createFactory<GovernmentOrganization>([OrganizationMixin, GovernmentOrganizationMixin], { types: [schema.GovernmentOrganization] }, env);
