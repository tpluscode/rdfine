...
export function RoofingContractorMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<RoofingContractor> & RdfResourceCore> & Base {
