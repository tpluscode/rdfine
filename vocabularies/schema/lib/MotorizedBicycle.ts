...
export interface MotorizedBicycle<ID extends ResourceNode = ResourceNode> extends Schema.Vehicle<ID>, RdfResource<ID> {
}

export function MotorizedBicycleMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
