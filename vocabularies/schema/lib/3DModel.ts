...
export interface _3DModel<ID extends ResourceNode = ResourceNode> extends Schema.MediaObject<ID>, RdfResource<ID> {
  isResizable: boolean | undefined;
}

export function _3DModelMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
