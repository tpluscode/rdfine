...
export interface UnitPriceSpecification<ID extends ResourceNode = ResourceNode> extends Schema.PriceSpecification<ID>, RdfResource<ID> {
  billingIncrement: number | undefined;
  priceType: string | undefined;
  referenceQuantity: Schema.QuantitativeValue<SiblingNode<ID>> | undefined;
