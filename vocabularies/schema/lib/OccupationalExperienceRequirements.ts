...
export const factory = (env: RdfineEnvironment) => createFactory<OccupationalExperienceRequirements>([IntangibleMixin, OccupationalExperienceRequirementsMixin], { types: [schema.OccupationalExperienceRequirements] }, env);
