...
export interface ShortStory<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
}

export function ShortStoryMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
