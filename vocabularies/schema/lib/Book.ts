...
export interface Book<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
  abridged: boolean | undefined;
  bookEdition: string | undefined;
  bookFormat: Schema.BookFormatType | undefined;
  illustrator: Schema.Person<SiblingNode<ID>> | undefined;
