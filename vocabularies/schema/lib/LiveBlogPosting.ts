...
export interface LiveBlogPosting<ID extends ResourceNode = ResourceNode> extends Schema.BlogPosting<ID>, RdfResource<ID> {
  coverageEndTime: Date | undefined;
  coverageStartTime: Date | undefined;
  liveBlogUpdate: Schema.BlogPosting<SiblingNode<ID>> | undefined;
}
