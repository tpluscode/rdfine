...
export const factory = (env: RdfineEnvironment) => createFactory<LegislativeBuilding>([GovernmentBuildingMixin, LegislativeBuildingMixin], { types: [schema.LegislativeBuilding] }, env);
