...
export function LegislativeBuildingMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<LegislativeBuilding> & RdfResourceCore> & Base {
