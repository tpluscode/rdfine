...
export function SpreadsheetDigitalDocumentMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<SpreadsheetDigitalDocument> & RdfResourceCore> & Base {
