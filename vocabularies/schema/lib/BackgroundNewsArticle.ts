...
export const factory = (env: RdfineEnvironment) => createFactory<BackgroundNewsArticle>([NewsArticleMixin, BackgroundNewsArticleMixin], { types: [schema.BackgroundNewsArticle] }, env);
