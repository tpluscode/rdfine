...
declare global {
  interface SchemaVocabulary {
    Country: Factory<Schema.Country>;
  }
}
...
CountryMixin.createFactory = (env: RdfineEnvironment) => createFactory<Country>([AdministrativeAreaMixin, CountryMixin], { types: [schema.Country] }, env)
