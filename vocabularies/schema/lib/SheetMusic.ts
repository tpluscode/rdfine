...
export interface SheetMusic<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
}

export function SheetMusicMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
