...
export const factory = (env: RdfineEnvironment) => createFactory<LifestyleModification>([MedicalEntityMixin, LifestyleModificationMixin], { types: [schema.LifestyleModification] }, env);
