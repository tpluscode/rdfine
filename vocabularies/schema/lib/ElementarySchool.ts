...
export const factory = (env: RdfineEnvironment) => createFactory<ElementarySchool>([EducationalOrganizationMixin, ElementarySchoolMixin], { types: [schema.ElementarySchool] }, env);
