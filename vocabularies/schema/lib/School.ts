...
SchoolMixin.createFactory = (env: RdfineEnvironment) => createFactory<School>([EducationalOrganizationMixin, SchoolMixin], { types: [schema.School] }, env)
