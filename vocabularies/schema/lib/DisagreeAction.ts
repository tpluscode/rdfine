...
declare global {
  interface SchemaVocabulary {
    DisagreeAction: Factory<Schema.DisagreeAction>;
  }
}
...
DisagreeActionMixin.createFactory = (env: RdfineEnvironment) => createFactory<DisagreeAction>([ReactActionMixin, DisagreeActionMixin], { types: [schema.DisagreeAction] }, env)
