...
export function AnalysisNewsArticleMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<AnalysisNewsArticle> & RdfResourceCore> & Base {
