...
export interface Comment<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
  downvoteCount: number | undefined;
  parentItem: Schema.Question<SiblingNode<ID>> | undefined;
