...
export function GovernmentBuildingMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<GovernmentBuilding> & RdfResourceCore> & Base {
