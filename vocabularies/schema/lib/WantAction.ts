...
declare global {
  interface SchemaVocabulary {
    WantAction: Factory<Schema.WantAction>;
  }
}
...
WantActionMixin.createFactory = (env: RdfineEnvironment) => createFactory<WantAction>([ReactActionMixin, WantActionMixin], { types: [schema.WantAction] }, env)
