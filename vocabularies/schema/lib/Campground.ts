...
export const factory = (env: RdfineEnvironment) => createFactory<Campground>([LodgingBusinessMixin, CivicStructureMixin, CampgroundMixin], { types: [schema.Campground] }, env);
