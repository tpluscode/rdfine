...
export interface Joint<ID extends ResourceNode = ResourceNode> extends Schema.AnatomicalStructure<ID>, RdfResource<ID> {
  biomechnicalClass: string | undefined;
  functionalClass: Schema.MedicalEntity<SiblingNode<ID>> | undefined;
