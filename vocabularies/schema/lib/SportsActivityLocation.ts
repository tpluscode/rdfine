...
export function SportsActivityLocationMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<SportsActivityLocation> & RdfResourceCore> & Base {
