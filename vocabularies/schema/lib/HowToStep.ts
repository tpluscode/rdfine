...
export const factory = (env: RdfineEnvironment) => createFactory<HowToStep>([ListItemMixin, ItemListMixin, CreativeWorkMixin, HowToStepMixin], { types: [schema.HowToStep] }, env);
