...
export const factory = (env: RdfineEnvironment) => createFactory<OpinionNewsArticle>([NewsArticleMixin, OpinionNewsArticleMixin], { types: [schema.OpinionNewsArticle] }, env);
