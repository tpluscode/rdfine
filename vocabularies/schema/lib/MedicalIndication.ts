...
export interface MedicalIndication<ID extends ResourceNode = ResourceNode> extends Schema.MedicalEntity<ID>, RdfResource<ID> {
}

export function MedicalIndicationMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
