...
export const factory = (env: RdfineEnvironment) => createFactory<MedicalIndication>([MedicalEntityMixin, MedicalIndicationMixin], { types: [schema.MedicalIndication] }, env);
