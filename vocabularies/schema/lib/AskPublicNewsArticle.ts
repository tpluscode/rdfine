...
export function AskPublicNewsArticleMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<AskPublicNewsArticle> & RdfResourceCore> & Base {
