...
declare global {
  interface SchemaVocabulary {
    Airport: Factory<Schema.Airport>;
  }
}
...
AirportMixin.createFactory = (env: RdfineEnvironment) => createFactory<Airport>([CivicStructureMixin, AirportMixin], { types: [schema.Airport] }, env)
