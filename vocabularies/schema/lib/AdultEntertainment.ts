...
export const factory = (env: RdfineEnvironment) => createFactory<AdultEntertainment>([EntertainmentBusinessMixin, AdultEntertainmentMixin], { types: [schema.AdultEntertainment] }, env);
