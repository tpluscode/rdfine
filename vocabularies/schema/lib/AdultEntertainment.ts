...
export function AdultEntertainmentMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<AdultEntertainment> & RdfResourceCore> & Base {
