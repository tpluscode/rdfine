...
export interface MaximumDoseSchedule<ID extends ResourceNode = ResourceNode> extends Schema.DoseSchedule<ID>, RdfResource<ID> {
}

export function MaximumDoseScheduleMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
