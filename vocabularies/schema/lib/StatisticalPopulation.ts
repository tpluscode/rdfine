...
export const factory = (env: RdfineEnvironment) => createFactory<StatisticalPopulation>([IntangibleMixin, StatisticalPopulationMixin], { types: [schema.StatisticalPopulation] }, env);
