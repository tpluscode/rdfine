...
export function EntertainmentBusinessMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<EntertainmentBusiness> & RdfResourceCore> & Base {
