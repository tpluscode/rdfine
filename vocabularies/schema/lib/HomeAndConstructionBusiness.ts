...
export const factory = (env: RdfineEnvironment) => createFactory<HomeAndConstructionBusiness>([LocalBusinessMixin, HomeAndConstructionBusinessMixin], { types: [schema.HomeAndConstructionBusiness] }, env);
