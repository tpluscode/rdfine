...
export const factory = (env: RdfineEnvironment) => createFactory<TreatmentIndication>([MedicalIndicationMixin, TreatmentIndicationMixin], { types: [schema.TreatmentIndication] }, env);
