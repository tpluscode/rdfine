...
declare global {
  interface SchemaVocabulary {
    HowToTool: Factory<Schema.HowToTool>;
  }
}
...
HowToToolMixin.createFactory = (env: RdfineEnvironment) => createFactory<HowToTool>([HowToItemMixin, HowToToolMixin], { types: [schema.HowToTool] }, env)
