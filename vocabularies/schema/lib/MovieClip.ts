...
declare global {
  interface SchemaVocabulary {
    MovieClip: Factory<Schema.MovieClip>;
  }
}
...
MovieClipMixin.createFactory = (env: RdfineEnvironment) => createFactory<MovieClip>([ClipMixin, MovieClipMixin], { types: [schema.MovieClip] }, env)
