...
declare global {
  interface SchemaVocabulary {
    UserPlusOnes: Factory<Schema.UserPlusOnes>;
  }
}
...
UserPlusOnesMixin.createFactory = (env: RdfineEnvironment) => createFactory<UserPlusOnes>([UserInteractionMixin, UserPlusOnesMixin], { types: [schema.UserPlusOnes] }, env)
