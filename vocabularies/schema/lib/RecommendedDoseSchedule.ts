...
export const factory = (env: RdfineEnvironment) => createFactory<RecommendedDoseSchedule>([DoseScheduleMixin, RecommendedDoseScheduleMixin], { types: [schema.RecommendedDoseSchedule] }, env);
