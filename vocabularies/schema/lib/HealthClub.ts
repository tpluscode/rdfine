...
export interface HealthClub<ID extends ResourceNode = ResourceNode> extends Schema.HealthAndBeautyBusiness<ID>, Schema.SportsActivityLocation<ID>, RdfResource<ID> {
}
