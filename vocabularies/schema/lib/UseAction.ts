...
declare global {
  interface SchemaVocabulary {
    UseAction: Factory<Schema.UseAction>;
  }
}
...
UseActionMixin.createFactory = (env: RdfineEnvironment) => createFactory<UseAction>([ConsumeActionMixin, UseActionMixin], { types: [schema.UseAction] }, env)
