...
export function PerformingArtsTheaterMixin<Base extends rdfine.Constructor>(Resource: Base): rdfine.Constructor<Partial<PerformingArtsTheater> & RdfResourceCore> & Base {
