...
declare global {
  interface SchemaVocabulary {
    BikeStore: Factory<Schema.BikeStore>;
  }
}
...
BikeStoreMixin.createFactory = (env: RdfineEnvironment) => createFactory<BikeStore>([StoreMixin, BikeStoreMixin], { types: [schema.BikeStore] }, env)
