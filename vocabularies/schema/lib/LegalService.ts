...
declare global {
  interface SchemaVocabulary {
    LegalService: Factory<Schema.LegalService>;
  }
}
...
LegalServiceMixin.createFactory = (env: RdfineEnvironment) => createFactory<LegalService>([LocalBusinessMixin, LegalServiceMixin], { types: [schema.LegalService] }, env)
