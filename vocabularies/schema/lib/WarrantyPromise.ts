...
export interface WarrantyPromise<ID extends ResourceNode = ResourceNode> extends Schema.StructuredValue<ID>, RdfResource<ID> {
  durationOfWarranty: Schema.QuantitativeValue<SiblingNode<ID>> | undefined;
