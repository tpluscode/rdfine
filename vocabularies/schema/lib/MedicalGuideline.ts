...
export interface MedicalGuideline<ID extends ResourceNode = ResourceNode> extends Schema.MedicalEntity<ID>, RdfResource<ID> {
  evidenceLevel: Schema.MedicalEvidenceLevel | undefined;
  evidenceOrigin: string | undefined;
  guidelineDate: Date | undefined;
  guidelineSubject: Schema.MedicalEntity<SiblingNode<ID>> | undefined;
}
