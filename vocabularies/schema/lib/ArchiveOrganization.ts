...
export interface ArchiveOrganization<ID extends ResourceNode = ResourceNode> extends Schema.LocalBusiness<ID>, RdfResource<ID> {
  archiveHeld: Schema.ArchiveComponent<SiblingNode<ID>> | undefined;
}
