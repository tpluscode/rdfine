...
export const factory = (env: RdfineEnvironment) => createFactory<ArchiveOrganization>([LocalBusinessMixin, ArchiveOrganizationMixin], { types: [schema.ArchiveOrganization] }, env);
