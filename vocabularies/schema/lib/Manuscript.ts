...
export interface Manuscript<ID extends ResourceNode = ResourceNode> extends Schema.CreativeWork<ID>, RdfResource<ID> {
}

export function ManuscriptMixin<Base extends Constructor>(Resource: Base) {
  @namespace(schema)
