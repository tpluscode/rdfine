...
export const factory = (env: RdfineEnvironment) => createFactory<RecordResourceHoldingRelation>([ManagementRelationMixin, RecordResourceHoldingRelationMixin], { types: [rico.RecordResourceHoldingRelation] }, env);
