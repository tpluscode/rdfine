...
export const factory = (env: RdfineEnvironment) => createFactory<CorrespondenceRelation>([KnowingRelationMixin, CorrespondenceRelationMixin], { types: [rico.CorrespondenceRelation] }, env);
