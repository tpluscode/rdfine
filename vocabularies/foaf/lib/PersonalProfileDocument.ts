...
export const factory = (env: RdfineEnvironment) => createFactory<PersonalProfileDocument>([DocumentMixin, PersonalProfileDocumentMixin], { types: [foaf.PersonalProfileDocument] }, env);
