...
declare global {
  interface FoafVocabulary {
    OnlineAccount: Factory<Foaf.OnlineAccount>;
  }
}
...
OnlineAccountMixin.createFactory = (env: RdfineEnvironment) => createFactory<OnlineAccount>([OnlineAccountMixin], { types: [foaf.OnlineAccount] }, env)
