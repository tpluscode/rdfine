...
export interface OnlineAccount<ID extends ResourceNode = ResourceNode> extends RdfResource<ID> {
  accountName: RDF.Literal | undefined;
  accountServiceHomepage: Foaf.Document<SiblingNode<ID>> | undefined;
}
