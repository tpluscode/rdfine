...
export interface OnlineGamingAccount<ID extends ResourceNode = ResourceNode> extends Foaf.OnlineAccount<ID>, RdfResource<ID> {
}

export function OnlineGamingAccountMixin<Base extends Constructor>(Resource: Base) {
  @namespace(foaf)
