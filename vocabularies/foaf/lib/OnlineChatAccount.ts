...
export interface OnlineChatAccount<ID extends ResourceNode = ResourceNode> extends Foaf.OnlineAccount<ID>, RdfResource<ID> {
}

export function OnlineChatAccountMixin<Base extends Constructor>(Resource: Base) {
  @namespace(foaf)
